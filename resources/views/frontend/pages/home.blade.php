...
<section id="blog_details" class="blog_details details-wrapper">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="col-sm-12 m-top-20">
                    ...
                    <input type="file" name="fileToUpload" id="fileToUpload" class="file-upload">
                    <button type="submit" class="btn btn-default share-post-btn">Share <i class="fa fa-long-arrow-right"></i></button>
                </div>
                <hr />
            </div>
            ...
            <div class="col-md-8">
                <div class="blog_fashion_content">
                    ...
                    <a href="{{ url('details') }}" class="btn btn-default m-top-20"> Read More <i class="fa fa-long-arrow-right"></i></a>
                </div>
                <hr />
            </div>
            <?php } ?>
                    ...
                    <div class="blog_details_left">
                        <div class="blog_details_content">
                            ...
                            <div class="blog_details_figure m-top-40">
                                ...
                                <p class="m-top-30">Claritas est etiam processus dynamicus, qui sequitur mutationem
